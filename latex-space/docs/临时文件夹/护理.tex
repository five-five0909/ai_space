...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 护理的基本任务是（     ）预防（   ）恢复（\qquad）和促进健康。
		\item 人类环境中内环境包括（\qquad）环境和（\qquad）环境，外环境包括（\qquad）环境和（\qquad）环境。
	\end{enumerate}
\end{examplebox}
...
\begin{tipsbox}{物理消毒灭菌法——湿热法}
	\begin{tabular}{|p{3cm}|p{5cm}|p{5cm}|}
		...
		\hline
		注意事项 & 1、器械包重量不超过7kg，敷料包重量不宜超过5kg。2、装载恰当:使用专用灭菌架或篮筐装载灭菌物品，灭菌包之间留有空隙。3、多种物品需同时灭菌时布类物品放在金属、陶瓷物品上面。 & 1、物品刷洗干净后全部浸没在水中$\geq$3cm，加热煮沸后维持$\geq$15分钟。消毒时间从水沸后算起。2、水沸后放入如中途加入物品，则在第二次水沸后重新计时。3、水的沸点受气压影响，一般海拔每增高300m，消毒时间需延长2分钟。4、为增强杀菌作用、去污防锈，可将碳酸氢钠加入水中，沸点可达到105℃。5、消毒后应将物品及时取出置于无菌容器内，及时应用，4小时内未用需要重煮消毒。 \\
		\hline
	\end{tabular}
\end{tipsbox}
...
\begin{tipsbox}{物理消毒灭菌法——辐射消毒法}
	\begin{tabular}{|p{3cm}|p{5cm}|p{5cm}|}
		...
		\hline
		概念   & 利用日光的热、干燥和紫外线作用达到消毒效果               & 紫外线波长为200$\sim$280nm，其中杀菌作用最强的为253.7nm                                                                                                \\
		\hline
		适用范围 & 常用于床垫、被服、书籍等物品的消毒                   & 可杀灭多种微生物，包括杆菌、病毒等                                                                                                                     \\
		\hline
		注意事项 & 将物品放在直射阳光下曝晒6小时，并定时翻动，使物品各面均能受到日光照射 & 1、紫外线消毒灯距离地面1.8$\sim$2.2m，数量$\geq$1.5W/m³，照射时间不少于30分钟 2、一般每周1次用70\%$\sim$80\%乙醇布巾擦拭 3、紫外线的消毒时间须从灯亮5$\sim$7分钟后开始计时，若使用时间超过1000小时，需更换灯管 \\
		\hline
	\end{tabular}
\end{tipsbox}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 能杀灭所有微生物以及细菌芽胞的方法是（ ）\\
		      A.清洁 \quad B.消毒 \quad C.抑菌 \quad D.灭菌 \quad E.抗菌
		\item 不适合使用干热法灭菌的是（ ）\\
		      A.玻璃制品 \quad B.陶瓷类 \quad C.油剂 \quad D.粉剂 \quad E.橡胶制品
		\item 海拔600m高处采用煮沸法消毒餐具时，需要延长消毒时间（ ）\\
		      A.2分钟 \quad B.3分钟 \quad C.4分钟 \quad D.5分钟 \quad E.6分钟
		\item 杀菌作用最强的紫外线波段是（ ）\\
		      A.210$\sim$230nm \quad B.230$\sim$250nm \quad C.250$\sim$270nm \quad D.270$\sim$300nm \quad E.300$\sim$320nm
		\item 不适用于燃烧法灭菌的是（ ）\\
...
\begin{table}[htbp]
	...
	\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
		...
		\hline
		包括 & 手术器械、穿刺针、腹腔镜、活检钳、脏器移植物等                        & 胃肠道内镜、气管镜、喉镜、体温表、呼吸机管道、压舌板等；菌落总$\leq$20CFU/件 & 听诊器、血压计、病床围栏、床面以及床头柜；菌落总数应$\leq$200CFU/件      \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|p{2cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
		...
		\hline
		要求 & 空气平均菌落：$\leq$150CFU/m³ 物品表面平均菌落：$\leq$5CFU/m³ & 物品表面平均菌落：$\leq$5CFU/m²           & 物品表面平均菌落：$\leq$10CFU/m² & 物品表面平均菌落：$\leq$10CFU/m²   \\
		\hline
...
\begin{examplebox}{练习题}
	烧伤病区属于II类环境，要求空气中的菌落总数不超过（\qquad）\\
...
\begin{itemize}
	\item \textbf{存放原则}：每个容器只放一把无菌持物钳，消毒液面浸没轴节以上2$\sim$3cm或镊子长度的1/2。（记忆口诀：想到持物钳和镊子有两个角，数字都是2）
	\item \textbf{使用原则}：
	      \begin{itemize}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 挂在衣钩上已穿过的隔离衣，被视为清洁的部位是（ ）\\
		      A.衣领 \quad B.袖口 \quad C.腰部以上 \quad D.腰部以下 \quad E.胸部以上
		\item 周先生，48岁，诊断为“急性传染性非典型肺炎”。对于隔离区域的划分，属于污染区的区域为（ ）\\
		      A.储物间 \quad B.治疗室 \quad C.医务人员值班室 \quad D.内走廊 \quad E.病室
		\item 刘先生，30岁，诊断为“伤寒”。对于刘先生使用过的床单，正确的处理步骤是（ ）\\
...
\begin{tipsbox}{本章填空题}
	\begin{enumerate}
		\item 构成感染链的三个基本条件是感染源、(     )和(      )。
		\item 根据病原体的来源分类，可将医院感染分为(    )感染和(    )感染。
		\item 医院感染的传播途径主要包括接触传播、(     )、(     )。
		\item 常用的消毒灭菌方法有两大类：(  )消毒灭菌法和(   )消毒灭菌法。
		\item 常用的化学消毒剂的使用方法有喷雾法、浸泡法、(   )法和(   )法。
		\item 医院用品的危险性通常分为三类：高度危险性物品、(      )、(       )。
		\item 层流洁净病房属于（\qquad）类环境。
		\item 干燥保存的无菌持物钳使用有效期为( )h；无菌容器一经打开，使用时间不超过(   )h。
		\item 无菌包内物品一次未用完，则按原折痕包好，有效期为(  )h；铺好的无菌盘有效期为(  )h。
		\item 根据患者获得感染危险性的程度，医院可分成4个区域：低危险区域、中等危险区域、(     )和(      )。
		\item 呼吸道传染病病区分为清洁区、(     )和(     )，并设立两通道和三区之间的缓冲间。
		\item 接触传播的隔离病室使用(   )色隔离标志，空气传播的隔离病室使用(  )色隔离标志，飞沫传播的隔离病室使用(  )色隔离标志。
	\end{enumerate}
\end{tipsbox}
...
自理能力（ability of self-care）是指在生活中个体照料自己的行为能力。其分级依据Barthel指数评定量表，对日常生活活动进行评定，根据Barthel指数总分，确定自理能力等级。Barthel指数（Barthel index，BI），范围在0$\sim$100分，是对患者日常生活活动的功能状态进行测量，个体得分取决于对一系列独立行为的测量。日常生活活动（activities of daily living，ADL）是人们为了维持生存及适应生存环境而每天反复进行的活动，其总分即为Barthel指数。根据总分，将患者的自理能力分为重度依赖、中度依赖、轻度依赖、无需依赖四个等级。
\begin{table}[htbp]
	\centering
	\caption{自理能力分级}
	\begin{tabular}{|l|l|l|}
		...
		\hline
		重度依赖            & 总分$\leq$40分     & 全部需要他人照护        \\
		中度依赖            & 总分41$\sim$60分   & 大部分需他人照护        \\
		轻度依赖            & 总分61$\sim$99分   & 少部分需他人照护        \\
		无需依赖            & 总分100分          & 无需他人照护          \\
		\hline
	\end{tabular}
\end{table}
...
\begin{enumerate}
	...
	\item \textbf{中凹卧位（休克卧位）}：
	      \begin{itemize}
		      \item 姿势：用垫枕抬高病人的头胸部约10°$\sim$20°，抬高下肢约20°$\sim$30°。
	...
	\item \textbf{半坐卧位}：
	      \begin{itemize}
		      \item 姿势：病人仰卧，先摇起床头支架使上半身抬高，与床呈30°$\sim$50°，再摇起膝下支架。
	...
	\item \textbf{俯卧位}：
	      ...
	      \end{itemize}
	\item \textbf{头低足高位}：床尾抬高15°$\sim$30°。适用范围：妊娠时胎膜早破。
	\item \textbf{头高足低位}：床头抬高15°$\sim$30°。适用范围：①颈椎骨折病人作颅骨牵引；②预防脑水肿，降低颅内压；③颅脑术后。
	\item \textbf{膝胸卧位}：
	      \begin{itemize}
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 患者单位的设备及管理要以患者的（   ）、（   ）和有利于患者（\qquad）为前提。
		\item 护士铺床时应遵循的原则是：先（\qquad），后（\qquad）；先（\qquad），后（\qquad）。
		\item 卧有患者更换床单法清扫和橡胶单的原则是；自（\qquad）至（\qquad）；自（\qquad）至（\qquad）。
		\item 仰卧位包括（\qquad）（\qquad）和（\qquad）。
		\item 根据卧位的平衡性，卧位可分为（\qquad）和（\qquad）；根据卧位的自主性可分为（\qquad）（\qquad）和（\qquad）三种卧位。
	\end{enumerate}
\end{tipsbox}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 双腿被开水烫伤的患者，可考虑为其选用的保护具是（\qquad）\\
...
\begin{itemize}
	...
	\item ③1\%$\sim$3\%过氧化氢溶液：抗菌、防口臭。
	\item ④醋酸溶液：适用于铜绿假单胞菌感染。
	\item ⑤1\%$\sim$4\%碳酸氢钠溶液：属碱性溶液，适用于真菌感染。
\end{itemize}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 为昏迷病人行口腔护理时，不需准备的用物是（ ）\\
		      A棉球 \quad B弯盘 \quad C开口器 \quad D吸水管 \quad E 弯止血钳
		\item 王某，女，30岁，诊断为血小板减少性紫癜。护士观察口腔时发现唇及口腔黏膜散在瘀点，轻触可出血，护士为其做口腔护理时应特别注意（ ）\\
		      A夹紧棉球 \quad B禁忌漱口 \quad C动作轻柔 \quad D先取下义齿 \quad E棉球不可过湿
		\item 护士在观察王先生口腔时，发现口腔黏膜有一感染溃烂处，应为其选用的口腔护理溶液是（ ）\\
		      A生理盐水 \quad B朵贝尔溶液 \quad C0.1\%醋酸溶液 \quad D3\%过氧化氢溶液 \quad E4\%碳酸氢钠溶液
		\item 张某，男，50岁，细菌培养显示口腔有铜绿假单胞菌感染，护士在为其进行口腔护理时应选用的口腔护理溶液是（ ）\\
		      A生理盐水 \quad B1\%-3\%过氧化氢溶液 \quad C1\%-4\%碳酸氢钠溶液 \quad D0.1\%醋酸溶液 \quad E朵贝尔溶液
		\item 患者，女，脑出血昏迷。护士为其做口腔护理时，取下的活动性义齿应放入（ ）\\
...
Braden量表是目前国内外用来预测压力性损伤发生的较为常用的方法之一，对压力性损伤高危人群具有较好的预测效果，且评估简便、易行。Braden量表的评估内容包括感觉、潮湿、活动力、移动力、营养及摩擦力和剪切力6个部分。总分值范围为6-23分，分值越小，提示发生压力性损伤的危险性越高。评分$\leq$18分，提示患者有发生压力性损伤的危险，建议采取预防措施。
...
\begin{tipsbox}{本章填空题}
	\begin{enumerate}
		\item 对于佩戴义齿的患者，取下的义齿应浸没于有标签的（\qquad）杯中，勿浸于（\qquad）或（\qquad）中，以免变色，变形和老化。
		\item 特殊口腔护理适用于高热，（\qquad）（\qquad）（\qquad），鼻饲，口腔疾患，术后及生活不能自理的患者。
		\item 对于口腔内有真菌感染的患者，应选择（\qquad）作为口腔护理溶液。
		\item 为昏迷患者行口腔护理时，禁止为患者（\qquad）、需用开口器协助患者开口时，应将其从（\qquad）放入。
		\item 常用灭头虱药液为30\%含酸百部酊剂，其组成成分为（     ）（      ）和（      ）。
		\item 患者沐浴的种类包括（   ）（   ）和（   ）。
		\item 沐浴应在（\qquad）进行，以免影响消化功能。
		\item 患者进行淋浴或盆浴时，护士应调节室温在（   ）以上，水温保持在（   ），或按患者习惯调节。
		\item 为患者进行床上擦浴时，脱上衣时应先脱（\qquad），后脱（\qquad）：若有肢体外伤或活动障碍，应先脱（\qquad），后脱（\qquad）。
		\item 护士在为患者进行床上擦浴时，应注意观察患者的病情变化，如出现（\qquad）（\qquad）和（\qquad）等征象，应立即停止擦浴，并给予适当处理。
		\item 引起压疮发生的常见原因包括：（\qquad）局部潮湿或排泄物刺激（\qquad）（\qquad）体温升高，矫形器械使用不当，机体活动和或感觉障碍，急性应激因素。
		\item 压疮不仅由（\qquad）引起，还可由（\qquad）和（\qquad）引起，通常是2-3种力联合作用所导致。
		\item 为预防压疮的发生，护士在工作中应做到六勤，即（\qquad）（\qquad）（\qquad）勤擦洗，勤整理和勤更换。
		\item 根据压疮的损伤程度，可将压疮分为（\qquad）（\qquad）（\qquad）和（\qquad）。
	\end{enumerate}
\end{tipsbox}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 张某，女70岁，脑出血后卧床，其肢体能抬离床面但不能对抗阻力，请判断该患者的肌力程度为（\qquad）\\
...
\end{enumerate}
\textbf{（二）40$\sim$42℃横线之间}
用红钢笔纵行在40$\sim$42℃间相应时间格内填写入院、转入、手术、分娩、出院、死亡时间。
\textbf{（三）体温曲线的绘制}
\begin{enumerate}
	\item 口温蓝“●”，腋温蓝“×”，肛温蓝“○”。
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 临时医嘱的有效时间在（\qquad）以内，一般执行（\qquad）次。
		\item 体温不升者，于（\qquad）℃处以下相应时间纵格内用（\qquad）钢笔写（\qquad），不再用相邻温度相连。
		\item 物理或药物降温半小时后测体温以（\qquad）表示，划在物理降温前温度的同一纵格内，并用（\qquad）线与降温前温度相连，下次测得的温度用（\qquad）线仍与降温前温度相连。
		\item 凡危重（\qquad）（\qquad）行特殊治疗或须严密观察病情的患者，应做好特别护理记录。
		\item 凡转科（\qquad）（\qquad）的患者或医嘱栏已写满换页时需要重整医嘱。
		\item 书写病案交班报告时，先写（\qquad）的患者，再写（\qquad）的患者，最后写（\qquad）患者。同一栏内的内容，按床号先后顺序书写报告。
		\item 病历交班报告最后写本班重点患者，即（\qquad）（\qquad）（\qquad）及有异常情况的患者。
	\end{enumerate}
\end{tipsbox}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|c|}
		...
		\hline
		口温          & 37.0℃         & 36.3$\sim$37.2℃ (97.3$\sim$99.0°F) \\
		肛温          & 37.5℃         & 36.5$\sim$37.7℃ (97.7$\sim$99.0°F) \\
		腋温          & 36.5℃         & 36.0$\sim$37.0℃ (96.8$\sim$98.6°F) \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|}
		...
		\hline
		低热          & 37.3$\sim$38.0℃ (99.1$\sim$100.4°F)  \\
		中等热         & 38.1$\sim$39.0℃ (100.6$\sim$102.2°F) \\
		高热          & 39.1$\sim$41.0℃ (102.4$\sim$105.8°F) \\
...
\subsubsection{常见热型}
\begin{enumerate}
	\item \textbf{稽留热}：体温持续在39$\sim$40℃，达数天或数周，24小时波动范围不超过1℃。见于肺炎球菌性肺炎、伤寒。
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\hline
		部位 & 舌下热窝        & 腋窝正中        & 直肠                 \\
		方法 & 闭口鼻呼吸       & 屈臂过胸        & 润滑肛表插入肛门3$\sim$4cm \\
		时间 & 3分钟         & 10分钟        & 3分钟                \\
		\hline
	\end{tabular}
\end{table}
...
\subsection{血压的评估与护理}
\subsubsection{正常血压}
收缩压：90$\sim$139mmHg (12$\sim$18.5kPa) \\
舒张压：60$\sim$89mmHg (8$\sim$11.8kPa) \\
脉压（收缩压与舒张压之差）：30$\sim$40mmHg (4 $\sim$ 5.3kPa) \\
...
\begin{enumerate}
	...
	\item \textbf{昼夜和睡眠}：上午6$\sim$10时及下午4$\sim$8时各有一个高峰，晚上8时后血压呈缓慢下降趋势，表现为“双峰双谷”。睡眠不佳，血压升高。
	\item \textbf{环境}：寒冷环境，血压略升高。高温环境，血压略下降。
	\item \textbf{体位}：卧位$<$坐位$<$立位。
	\item \textbf{身体不同部位}：右上肢高于左上肢(10$\sim$20mmHg)，下肢血压高于上肢(20-40mmHg)。
\end{enumerate}

\subsubsection{异常血压的评估}
\begin{enumerate}
	\item \textbf{高血压}：指在未使用降压药物的情况下，18岁以上成年人收缩压$\geq$140mmHg和/或舒张压$\geq$90mmHg。
...
\begin{enumerate}
	...
	\item 缠袖带：下缘距肘窝2$\sim$3cm，松紧以能插入一指为宜。
...
\subsection{呼吸的评估与护理}
\subsubsection{正常呼吸}
正常成人安静状态下呼吸频率为16$\sim$20次/分，节律规则，男性及儿童以腹式呼吸为主，女性以胸式呼吸为主。

\subsubsection{异常呼吸的评估}
\textbf{1. 频率异常}
\begin{itemize}
	\item \textbf{呼吸过速}：也称气促，指呼吸频率超过24次/分。见于发热、疼痛、甲状腺功能亢进等。一般体温每升高1℃，呼吸频率约增加3$\sim$4次/分。
...
\begin{enumerate}
	...
	\item \textbf{吸痰法}：
	      \begin{itemize}
		      \item 调节负压：成人40.0$\sim$53.3kPa，儿童$<$40.0kPa。
	      ...
	      \begin{itemize}
		      \item \textbf{缺氧程度的判断}
		            \begin{table}[htbp]
			            ...
			            \begin{tabular}{|l|c|c|l|l|}
				            ...
				            \hline
				            轻度          & $>$6.67            & $>$80             & 无发绀           & 不需要         \\
				            中度          & 4$\sim$6.67        & 60$\sim$80        & 发绀、呼吸困难       & 需要          \\
		      ...
		      \item \textbf{用氧注意事项}
		            \begin{enumerate}
			            ...
			            \item 常用湿化液为冷开水、蒸馏水。急性肺水肿用20\%$\sim$30\%乙醇（减少肺泡内泡沫表面张力）。
			            \item 氧气筒内氧勿用尽，压力表至少要保留0.5kPa（5kg/cm²）。
			            \item 对未用完或已用尽的氧气筒，应分别悬挂满或空标志。
			            \item 用氧过程中，应加强监测。
			            \item 注意：Ⅱ型呼吸衰竭（PaO2＜60mmHg，PaCO2＞50mmHg），应给予低浓度、低流量(1$\sim$2L/min)给氧（记忆：一型呼吸衰竭只有一个原因缺氧，二型既有缺氧又有二氧化碳潴留）。
		            \end{enumerate}
	      \end{itemize}
\end{enumerate}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 患者柯某，女，36岁，支气管扩张。护士指导患者作体位引流时应避免（\qquad）\\
		      A.在饭后0.5h进行 \quad B.行超声雾化吸入提高疗效 \quad C.引流同时作胸部叩击 \quad D.引流体位是患肺处于高位 \quad E.每次引流15$\sim$30min
		\item 患者黄某，男，28岁。因慢性阻塞性肺部疾病需氧气治疗，有关氧疗的作用不妥的是（\qquad）\\
		      A.增加动脉血氧含量 \quad B.提高动脉血氧分压 \quad C.供给热能 \quad D.改善缺氧状态 \quad E.维持机体生命活动
		\item 患者范某，男，60岁，因肺源性心脏病收住入院治疗，护士巡视病房时，发现患者有明显呼吸困难及口唇发绀，血气分析：PaO2 5.2KPa，SaO2 70\%，请判断其缺氧程度（\qquad）\\
		      A.极轻度 \quad B.轻度 \quad C.中度 \quad D.重度 \quad E.极重度
		\item 患者苏某，男，52岁，急性肺水肿。给予20\%-30\%乙醇湿化给氧其目的是（\qquad）\\
		      A.刺激呼吸中枢 \quad B.促使氧气快速湿润 \quad C.吸收水分，减轻肺水肿 \quad D.降低肺泡内泡沫的表面张力 \quad E.刺激血管收缩，减少渗出
		\item 患者胡某，女，75岁。呼吸困难，给予氧气吸入，吸入的氧浓度为33\%，每分钟的氧流量是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\setcounter{enumi}{2}
		\item 发热过程包括体温（\qquad）期、高热（\qquad）期、退热期三个时期。
		\item 体温上升期的特点是（\qquad），退热期的特点是（\qquad）。
		\item 口温测量时，将口表水银端斜放于（\qquad），闭紧口唇，用鼻呼吸，时间（\qquad）min。
		\item 将全部体温计的水银柱甩至35℃以下，同时放入已测好的40℃以下的水中，（\qquad）min后检视，若误差在（\qquad）℃以上则不能使用。
		\item 脉搏短绌的特点是心律（\qquad）、心率（\qquad）、心音强弱不等。
		\item 吸气时脉搏明显（\qquad）或（\qquad）称为奇脉。常见于心包积液和缩窄性心包炎。
		\item 寒冷环境血压可略（\qquad）；高温环境血压可略（\qquad）。
		\item 水银血压计玻璃管面上刻度的最小分值分别为（\qquad）mmHg或（\qquad）kPa。
		\item 测量血压时应将袖带平整置于上臂中部，下缘距肘窝（\qquad）cm，松紧以能插入（\qquad）指为宜。
		\item 密切观察血压者，应做到四定，即定（\qquad）、定（\qquad）、定体位和定血压计。
		\item 女性以（\qquad）呼吸为主；男性和儿童以（\qquad）呼吸为主。
		\item 叩击时操作者将手固定成背隆掌空状，自下而上，由（\qquad）向（\qquad）轻轻叩打。
		\item 注意用氧安全。切实做好防震、防火、防（\qquad）、防（\qquad）。
		\item 使用氧气时，应先调节流量后应用。停用氧气时，应先（\qquad），再（\qquad）。
		\item 当氧浓度高于（\qquad）％，持续时间超过（\qquad）h，可出现氧疗副作用。
		\item II型呼吸衰竭患者应给予（\qquad）（\qquad）持续吸氧。
	\end{enumerate}
\end{tipsbox}
...
\begin{enumerate}
	...
	\item \textbf{温水擦浴或乙醇擦浴注意事项}
	      \begin{itemize}
		      \item 冰袋置头部，热水袋置足底。
		      \item 拭浴温度、浓度：温水拭浴32$\sim$34℃。
		      \item 乙醇拭浴30℃，25\%$\sim$35\%乙醇。
	      \end{itemize}
...
\begin{enumerate}
	\item \textbf{热水袋使用注意事项}：
	      \begin{itemize}
		      \item 测量、调节水温：成人60$\sim$70℃；昏迷、老人、婴幼儿、感觉迟钝者水温应低于50℃。
		      \item 备热水袋：灌热水袋（1/2-2/3满）。
	      \end{itemize}
	\item \textbf{红外线灯及烤灯使用注意事项}：
	      \begin{itemize}
		      \item 调节：灯距为30$\sim$50cm，温热为宜，用手试温。
		      \item 照射：20$\sim$30分钟，注意保护局部。
	      \end{itemize}
	\item \textbf{热水坐浴注意事项}：
	      \begin{itemize}
		      \item 配药、调温：配置药液置于浴盆内1/2满，调节水温40$\sim$45℃。
		      \item 坐浴时间：待适应水温后坐浴，坐浴15$\sim$20分钟。
	      \end{itemize}
\end{enumerate}

\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 下列影响冷热疗的因素中错误的是（\qquad）\\
		      A.冷疗的方法不同，效果也不同 \quad B.冷疗效果与面积成正比 \quad C.冷疗时间与效果成正比 \quad D.不同个体对冷的反应不同 \quad E.环境温度影响冷效应
		\item 陈某，女，61岁。因经常便后出血，经检查患有痔疮，行痔疮手术。术后医嘱热水坐浴。以下热水坐浴措施中，错误的是（\qquad）\\
		      A.浴盆和溶液须无菌 \quad B.操作前需排空膀胱 \quad C.水温控制在50℃左右 \quad D.坐浴后更换敷料 \quad E.坐浴时间15-20min
		\item 患者，男，30岁，鼻唇沟处有一感染化脓灶，以下护理措施中错误的是（\qquad）\\
		      A.肌内注射抗生素 \quad B.口服抗生素 \quad C.局部换药处理 \quad D.局部湿热敷 \quad E.局部涂抗生素药膏
		\item 李先生，35岁，左侧踝关节扭伤。为防止皮下出血与肿胀，早期应（\qquad）\\
		      A.冷热交替敷 \quad B.局部按摩 \quad C.冷湿敷 \quad D.热湿敷 \quad E.松节油涂擦
		\item 小张因走路不慎导致脚踝扭伤，护士为其应用化学致冷袋冷敷局部，此时应用冷疗的主要目的不包括（\qquad）\\
		      A.减轻局部充血 \quad B.减轻神经末梢的敏感性 \quad C.控制炎症的扩散 \quad D.减轻局部的肿胀 \quad E.减轻局部出血
		\item 李阿姨，70岁，胆囊切除术后，因感畏寒而在足部使用热水袋时，使用过程中发现局部皮肤发生潮红、疼痛，此时正确的处理是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 高热降温时可置冰袋于（\qquad）、（\qquad）和体表大血管流经处。
		\item 乙醇拭浴拍拭双上肢时应在（\qquad）、（\qquad）、（\qquad）处稍用力并延长停留时间，以促进散热。
		\item 成人使用热水袋的水温应控制在（\qquad）℃，老人、婴幼儿等特殊患者使用热水袋的水温应低于（\qquad）℃。
		\item 冰帽使用的目的是（\qquad）、（\qquad）。
		\item 为患者进行冷湿敷时，敷布须透冰水，拧至（\qquad）为宜。
		\item 乙醇拭浴时应禁忌拭浴（\qquad）、（\qquad）、（\qquad）、足底等部位。
	\end{enumerate}
\end{tipsbox}
...
\textbf{鼻饲法考点}
\begin{enumerate}
	\item 插入长度一般为前额发际至胸骨剑突处或由鼻尖经耳垂至胸骨剑突处的距离。一般成人插入长度为45$\sim$55cm，婴幼儿大约14-18cm。
	\item 插入胃管约10$\sim$15cm（咽喉部）时，嘱清醒患者做吞咽动作，顺势将胃管向前推进，至预定长度。昏迷患者则用左手将患者头托起，使下颌靠近胸骨柄，缓缓插入胃管至预定长度。
	...
	\item \textbf{确认胃管是否在胃内的三种方法：}
	      ...
	      \end{enumerate}
	\item 鼻饲液温度应保持在38$\sim$40℃左右，避免过冷或过热；每次鼻饲不超过200ml。
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\setcounter{enumi}{5}
		\item 医院饮食可分为（\qquad）饮食、（\qquad）饮食及（\qquad）饮食三大类。
		\item 医院基本饮食包括普通饮食、（\qquad）饮食、（\qquad）饮食、和（\qquad）饮食四种。
		\item 一般成人鼻饲管插入深度相当于患者前额（\qquad）到胸骨（\qquad）的长度。
		\item 鼻饲饮食应注意每次鼻饲量不超过（\qquad）ml，间隔时间应大于（\qquad）h。
		\item 护士给一患者插入胃管时，患者出现呛咳、呼吸困难，表明胃管（\qquad），应（\qquad）。
		\item 应用普通胃管长期鼻饲患者应每天进行（\qquad）口腔护理，并（\qquad）更换胃管一次。
		\item 根据补充营养的量，胃肠外营养可分为（\qquad）胃肠外营养和（\qquad）胃肠外营养。
	\end{enumerate}
\end{tipsbox}
...
\begin{enumerate}
	\item \textbf{排尿次数}：正常成人白天3$\sim$5次，夜间0$\sim$1次。
	\item \textbf{尿量}：正常人24h的尿量约1000$\sim$2000ml，平均在1500ml左右。
	\item \textbf{颜色}：正常新鲜尿液呈淡黄色或深黄色。
	\item 正常人尿液呈弱酸性，一般尿液pH为4.5$\sim$7.5。
	\item 正常成人的尿比重波动于1.015$\sim$1.025之间，若尿比重经常固定于1.010左右，提示肾功能严重障碍。
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textbf{颜色}：在病理情况时，尿的颜色可有以下变化：
	      \begin{itemize}
		      \item 血尿－尿沉渣每高倍镜视野红细胞$\geq$3个；洗肉水色。
...
\textbf{护理措施：}
\begin{enumerate}
	\item 若需行留置导尿管术，导尿管插入时见尿后再插入7$\sim$10cm。
	\item 鼓励患者多饮水：每日摄入2000ml以上，达到冲洗尿道的目的。
	\item 训练膀胱反射功能，可采用间歇性夹管方式：夹闭导尿管，每3$\sim$4h开放1次，使膀胱定时充盈和排空，促进膀胱功能的恢复。
...
\begin{table}[htbp]
	...
	\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
		...
		\hline
		液面距离肛门 & 40$\sim$60cm                                                                                                                   & 不超过30cm                                                               & 不超过30cm                                                                  \\
		\hline
		插入长度   & 7$\sim$10cm                                                                                                                    & 7-10cm                                                                & 15$\sim$20cm                                                             \\
		\hline
		常用溶液   & 1.0.1\%$\sim$0.2\%的肥皂液、生理盐水。2.成人每次用量为500$\sim$1000ml，小儿200$\sim$500ml。3.溶液温度一般为39$\sim$41℃，降温时用28$\sim$32℃，中暑用4℃。              & “1、2、3”溶液（50\%硫酸镁30ml、甘油60ml、温开水90ml）；溶液温度为38℃。                       & 1.灌肠溶液量不超过200ml。溶液温度38℃。2.镇静、催眠用10\%水合氯醛。                                \\
		\hline
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 正常人24h的尿量约（\qquad）ml，平均在（\qquad）ml左右。
		\item 当泌尿系统感染时新鲜尿液发出（\qquad）臭味。糖尿病酮症酸中毒患者的尿液呈（\qquad）气味。
		\item 膀胱刺激征主要表现为（\qquad）、（\qquad）、（\qquad）。
		\item 女性患者导尿一般插入尿管的长度为（\qquad）cm；男性患者导尿一般插入尿管的长度为（\qquad）cm。
		\item 当膀胱高度膨胀时，第一次导尿量不应超过（\qquad）ml，以免导致患者出现（\qquad）和（\qquad）。
		\item 24h尿量少于（\qquad）ml为少尿。24h尿量大于（\qquad）ml为多尿。
		\item 尿失禁可分为（\qquad）、（\qquad（\qquad））、（\qquad）尿失禁。
		\item 慢性痢疾患者进行保留灌肠常采取（\qquad）卧位，阿米巴痢疾病患者灌肠应取（\qquad）卧位。
		\item 上消化道出血的患者粪便常表现为（\qquad）颜色；胆道梗阻患者的大便常表现为（\qquad）颜色。
		\item 肛管排气时肛管插入的深度是（\qquad）cm，保留灌肠时肛管插入的深度为（\qquad）cm。
		\item 成人每次灌肠的溶液量为（\qquad）ml，小儿（\qquad）ml。溶液温度一般为（\qquad）℃，降温时用（\qquad）℃，中暑时溶液温度为4℃。
		\item 肝性脑病患者禁用（\qquad）灌肠；充血性心力衰竭和水钠潴留患者禁用（\qquad）灌肠；急腹症，消化道出血、妊娠、严重心血管疾病等患者禁忌（\qquad）。
	\end{enumerate}
\end{tipsbox}
...
\begin{itemize}
	...
	\item 进针角度：与皮肤呈30°$\sim$40°角。
	\item 常用注射部位：上臂三角肌下缘、上臂外侧、腹部、大腿前侧和外侧方及后背。
	\item 进针深度：针梗的1/2$\sim$2/3刺入皮下。
	\item 抽吸无回血，推注药液。
...
\textbf{（八）特殊病人的静脉穿刺要点}
\begin{enumerate}
	\item 肥胖病人：静脉上方进针，进针角度稍加大（30°$\sim$40°）。
...
\begin{enumerate}
	...
	\item 方法：前臂掌侧下段皮内注射青霉素皮试溶液0.1ml（含青霉素20$\sim$50U）；注射后观察20分钟，20分钟后判断并记录试验结果。
	...
	\item \textbf{青霉素过敏性休克及其处理}
	      \begin{enumerate}
		      ...
		      \item 根据医嘱静脉注射地塞米松5$\sim$10mg或将琥珀酸钠氢化可的松200$\sim$400mg加入5\%$\sim$10\%葡萄糖溶液500ml内静脉滴注；应用抗组胺类药物，如肌内注射盐酸异丙嗪25-50mg或苯海拉明40mg。
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 药物保管原则上规定药瓶上应有明显标签。内服药为（\qquad）色边、外用药为（\qquad）色边、剧毒药为（\qquad）色边。
		\item 给药后要注意观察药物（\qquad）和（\qquad）反应，并做好记录。
		\item 皮内注射时，针头与皮肤呈（\qquad）角刺入。
		\item 皮下注射时，针头与皮肤呈（\qquad）角，迅速将针头的（\qquad）刺入。
		\item 肌内注射时，针头与皮肤呈（\qquad）角，迅速将针头的（\qquad）刺入。
		\item 防止药物过敏，在使用高致敏性药物前，应该询问（\qquad）、（\qquad）和（\qquad），并做过敏试验。
		\item 青霉素过敏试验溶液为，每ml含（\qquad）青霉素为标准。
		\item 链霉素过敏试验溶液为，每ml含（\qquad）链霉素为标准。
		\item TAT过敏试验溶液为，每ml含（\qquad）TAT为标准。
		\item 青霉素过敏者出现血清病型反应，一般于用药后（\qquad）天内发生。临床表现和（\qquad）相似。
		\item 以前曾用过TAT而超过（\qquad）天者，如再使用，须重作过敏试验。
	\end{enumerate}
\end{tipsbox}
...
\begin{itemize}
	...
	\item \textbf{处理}：
	      \begin{enumerate}
		      ...
		      \item 给予高流量氧气吸入，一般氧流量为6$\sim$8L/min，湿化瓶内加入20\%-30\%的乙醇溶液，以减低肺泡内泡沫表面张力，减轻缺氧症状。
		      \item 遵医嘱给予镇静、平喘、强心、利尿和扩血管药物。
		      \item 必要时进行四肢轮扎，加压时要确保动脉血仍可通过，且须每5$\sim$10分钟轮流放松一个肢体上的止血带。
		      \item 静脉放血200$\sim$300ml（此法慎用）。
	      \end{enumerate}
\end{itemize}
...
\begin{itemize}
	...
	\item 临床表现：发生在输血中或输血后1$\sim$2小时内发生。畏寒、寒战、发热，体温可达38$\sim$41℃。可伴有皮肤潮红、头痛、恶心、呕吐等。
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 马女士，40岁，因再障贫血住院治疗。近10天连续输血治疗；出现心慌、气促、手足抽搐，检查心率40次/分，血压75/50mmHg。病人出现的输血反应是（\qquad）\\
		      A.肺水肿 \quad B.发热反应 \quad C.过敏反应 \quad D.空气栓塞 \quad E.枸橼酸钠中毒
		\item 关于采集血标本的操作方法，错误的是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 静脉输液是利用（\qquad）和（\qquad）形成的输液系统内压高于人体静脉压的原理将液体输入静脉内。
		\item 临床输液常用的液体包括（\qquad）溶液、（\qquad）溶液和静脉高营养液。
		\item 临床补钾的"四不宜"原则是：不宜（\qquad）、不宜（\qquad）、不宜（\qquad）和不宜（\qquad）。
		\item 静脉输液时，婴儿多采用（\qquad）静脉，因为它易于（\qquad）。
		\item 对于长期输液的患者，应先从（\qquad）远心端静脉开始使用，逐渐向（\qquad）移动，做到有计划使用静脉。
	\end{enumerate}
\end{tipsbox}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		...
		\item 留取尿标本查17–羟类固醇、17–酮类固醇时，应加入的防腐剂是（\qquad）\\
		      A.草酸 \quad B.甲苯 \quad C.甲醛 \quad D.稀盐酸 \quad E.浓盐酸
		\item 患者，女，26岁，近一个月来因不规则发热、乏力、体重减轻而入院，经检查发现有房间隔缺损，并初步诊断合并亚急性细菌性心内膜炎，医嘱行血培养。采血量至少为（\qquad）\\
		      A.20ml \quad B.10ml \quad C.5ml \quad D.3ml \quad E.1ml
		\item 患者，女，50岁，为明确诊断，需留取尿常规标本，护士应告知患者正确的方法为（\qquad）\\
		      A.留取晨起第一次尿 \quad B.饭前半小时留取 \quad C.随时收集尿液 \quad D.收集12h尿 \quad E.收集24h尿
		\item 患者，女，43岁，以肾小球肾炎收入院，医嘱做艾迪计数检查。护士在执行此医嘱时做法不正确的是（\qquad）\\
		      A.向患者解释留尿目的及配合方法 \quad B.准备大口带盖容器 \quad C.容器内加甲苯防腐 \quad D.嘱患者晨7时排空膀胱后开始留尿 \quad E.做好交接班，督促患者准确留取尿液
		\item 患者，女，怀疑为阿米巴痢疾，为明确诊断，医嘱留大便标本查找阿米巴原虫。护士应为患者选择的标本容器是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 采集标本前应认真查对医嘱，核对患者的（\qquad）、（\qquad）、（\qquad）、申请项目等，确认无误后方可进行。
		\item 静脉血标本包括（\qquad）、（\qquad）和（\qquad）三种。
		\item 采集动脉血标本时常用的动脉有（\qquad）、（\qquad）。
		\item 为避免尿液久放变质，收集12h或24h尿标本时常用的防腐剂有（\qquad）、（\qquad）和（\qquad）。
		\item 咽拭子标本采集是从（\qquad）及（\qquad）取分泌物做（\qquad）或病毒分离。
	\end{enumerate}
\end{tipsbox}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 属于非阿片类镇痛药的是（\qquad）\\
		      A.吗啡 \quad B.布洛芬 \quad C.阿托品 \quad D.哌替啶 \quad E.芬太尼
		\item 患者，刘某，肝癌末期疼痛，护士给该患者镇痛治疗，需要对其疼痛治疗前后效果测定对比，最适宜的评估方法是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 三级阶梯镇痛疗法的第一阶梯使用（\qquad）镇痛药，主要适用于（\qquad）的患者。
		\item 三级阶梯镇痛疗法的第二阶梯选用（\qquad）镇痛药，主要适用于（\qquad）的患者。
		\item 三级阶梯镇痛疗法的第三阶梯选用（\qquad）镇痛药，主要适用于（\qquad）和剧烈癌痛的患者。
	\end{enumerate}
\end{tipsbox}
...
\subsubsection{瞳孔的观察}
\begin{enumerate}
	\item \textbf{形状、大小与对称性}：正常瞳孔呈圆形，两侧等大等圆，位置居中，边缘整齐，直径为2$\sim$5mm。
	      \begin{itemize}
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 患者处于持续睡眠状态，但能被言语或轻度刺激唤醒，刺激去除后又很快入睡，此时患者处于（\qquad）\\
		      A.嗜睡 \quad B.意识模糊 \quad C.昏睡 \quad D.浅昏迷 \quad E.深昏迷
		\item 意识完全丧失，对各种刺激均无反应，全身肌肉松弛，深浅反射均消失，此时患者处于（\qquad）\\
		      A.嗜睡 \quad B.意识模糊 \quad C.昏睡 \quad D.浅昏迷 \quad E.深昏迷
		\item 护理昏迷患者，下列选项正确的是（\qquad）\\
		      A.测口温时护士要扶托体温计 \quad B.用干纱布盖眼以防角膜炎 \quad C.保持病室安静，光线宜暗 \quad D.防止患者坠床用约束带 \quad E.每隔3h给患者鼻饲流质
		\item 正常瞳孔在自然光线下直径的范围是（\qquad）\\
		      A.1mm \quad B.1.0$\sim$1.5mm \quad C.2$\sim$5mm \quad D.5.5$\sim$6mm \quad E.6mm以上
		\item 观察患者昏迷深浅度的最可靠指标是（\qquad）\\
...
\begin{examplebox}{练习题}
	\begin{enumerate}
		\item 胸外心脏按压频率为（\qquad）\\
		      A.20$\sim$40次/分 \quad B.40$\sim$60次/分 \quad C.60$\sim$80次/分 \quad D.80$\sim$100次/分 \quad E.100次以上
		\item 为成人进行人工呼吸时呼吸频率为（\qquad）\\
		      A.5$\sim$7次/分 \quad B.8$\sim$10次/分 \quad C.11$\sim$13次/分 \quad D.14$\sim$16次/分 \quad E.16次/分以上
		\item 心脏按压时，按压部位及抢救者双手的摆放是（\qquad）\\
		      A.胸骨中、下1/3交界处，双手平行叠放 \quad B.胸骨中、下1/3交界处，双手垂直叠放 \quad C.胸骨左缘两横指，双手平行叠放 \quad D.胸骨左缘两横指，双手垂直叠放 \quad E.心前区、双手垂直叠放
		\item 急性中毒患者，当诊断不明时，应选择的洗胃液是（\qquad）\\
		      A.1：15000高锰酸钾 \quad B.温开水或生理盐水 \quad C.牛奶 \quad D.3\%过氧化氢 \quad E.2\%$\sim$4\%碳酸氢钠
		\item 吞服强酸、强碱类腐蚀性药物的患者，切忌进行的护理操作是（\qquad）\\
		      A.口腔护理 \quad B.洗胃 \quad C.导泻 \quad D.灌肠 \quad E.输液
		\item 成人洗胃灌注量每次应为（\qquad）\\
		      A.200ml \quad B.300$\sim$500ml \quad C.500$\sim$800ml \quad D.800$\sim$1000ml \quad E.1000$\sim$1200ml
		\item 患者，女性，误食灭鼠药（磷化锌）中毒，被送入急诊室，此时为患者洗胃最好选用（\qquad）\\
		      A.温开水 \quad B.生理盐水 \quad C.2\%碳酸氢钠 \quad D.1：15000$\sim$1：20000高锰酸钾 \quad E.4\%碳酸氢钠
		\item 患者张某，患尿毒症，护士查房时发现他表情冷漠，反应迟钝，这种表现是（\qquad）\\
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 意识障碍分为嗜睡、（\qquad）、昏睡、（\qquad）四种类型。
		\item 洗胃溶液一般每次用量为（\qquad）ml，将洗胃溶液温度调节到（\qquad）℃范围内为宜。
		\item 应用简易呼吸器一次挤压可有（\qquad）ml空气进入肺内，频率应保持（\qquad）次/分。
		\item 实施胸外心脏按压术时按压的部位为胸骨（\qquad）、（\qquad）1/3交界处，按压频率为每分钟至少（\qquad）次以上。
	\end{enumerate}
\end{tipsbox}
...
\begin{tipsbox}{填空题}
	\begin{enumerate}
		\item 临终关怀是从以（\qquad）为主的治疗转变为以对症为主的（\qquad）。
		\item 死亡过程一般分为三个阶段，即（\qquad）期、（\qquad）期和（\qquad）期。
		\item 临终患者的心理反应经历了五个阶段，即否认期、（\qquad）期、协议期、（\qquad）期、（\qquad）期。
		\item 临床死亡期的特征是（\qquad）、（\qquad）完全停止，各种（\qquad）消失。
		\item 哈佛大学脑死亡的标准包括无感受性和反应性、无运动和无呼吸、（\qquad）、（\qquad）。
		\item 随着生物学死亡期的进展，相继出现尸冷、尸斑、（\qquad）及（\qquad）等现象。
		\item 若患者死亡时为侧卧位，应将其转为（\qquad）位，目的是防止（\qquad）变色。
	\end{enumerate}
\end{tipsbox}
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 某护生在一所二级甲等医院完成毕业实习后，但未通过护士执业资格考试。护理部考虑其平时无护理差错，且普外科护士严重短缺，因此聘用其任普外科护士，护理部的做法违反的是（\qquad）\\
		      A.护士条例 \quad B.侵权责任法 \quad C.民法通则 \quad D.医疗机构管理办法 \quad E.医疗事故处理条例
		\item 某护士受聘于一家医院，其尚未取得护士执业证书，目前她不能从事的工作是（\qquad）\\
		      A.清洁出院患者的床单位 \quad B.协助卧床患者变换体位 \quad C.协助患者进食 \quad D.协助患者如厕 \quad E.为尿潴留患者导尿
		\item 患者女，因甲状腺功能亢进行甲状腺大部切除术。术后10小时护士发现病人明显呼吸困难发绀，伤口左侧明显肿胀、皮肤张力大。护士如采取下列哪项措施将违反《护士条例》规定（\qquad）\\
...
\begin{examplebox}{典型考题}
	\begin{enumerate}
		\item 护士在给甲床输液的患者更换液体时，错将乙床患者的青霉素钠盐换给甲床患者，造成甲床患者过敏死亡。按照《医疗事故处理》规定，该医疗事故定级别为（\qquad）\\
		      A.四级医疗事故 \quad B.三级医疗事故 \quad C.二级医疗事故 \quad D.一级医疗事故 \quad E.一般差错
		\item 某患者因牙痛到医院就医，医生诊断后为其拔除了牙齿。术后患者仍感患处肿痛，再次就诊发现医生拔错了牙齿。遂将医院告上法庭。法院经调查发现医院存在过失，负全部责任。该事件属于（\qquad）\\
		      A.一级医疗事故 \quad B.二级医疗事故 \quad C.三级医疗事故 \quad D.不构成医疗事故 \quad E.四级医疗事故
		\item 某护士根据注射单给患者输液。当她在操作后查对时，发现误将邻床患者的液体误输给该患者。她立即停止输液并更换了正确的液体，未给该患者造成任何不良后果。该种情况属于（\qquad）\\
...
\begin{examplebox}{典型考题}
	\begin{enumerate}
		\item 某值班护士在23:00行药物治疗时，由于患者已入睡，护士未叫醒患者，错将患者甲的药物输给患者乙，导致患者乙出现皮肤过敏反应，此事件中，该护士应承担（\qquad）\\
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 对于危重症患者或大手术后需要特殊护理的患者宜采用的护理工作模式是（\qquad）\\
		      A.个案护理 \quad B.小组护理 \quad C.功能制护理 \quad D.责任制护理 \quad E.系统性整体护理
		\item 护士小张和小王在同一个病房工作，病房护理人员分为两组，每组3人，她们分别为组长，带领护士为患者提供服务，护士们互相配合完成工作。这种工作模式是（\qquad）\\
		      A.个案护理 \quad B.功能制护理 \quad C.责任制护理 \quad D.小组护理 \quad E.临床路径
		\item 小张、小王、小刘、小李均是医院综合内科的护士，小张是处理医嘱的主班护士，小王是治疗护士，小李是药疗护士，小刘是生活护理护士。她们每隔一段时间就会由护士长安排进行调换岗位。这种工作方式被称为（\qquad）\\
		      A.个案护理 \quad B.功能制护理 \quad C.责任制护理 \quad D.小组护理 \quad E.临床路径
		\item 由责任护士和其辅助护士负责一定数量患者从入院到出院，以护理计划为内容，包括入院教育、各种治疗、基础护理和专科护理、护理病历书写、观察病情变化、心理护理、健康教育、出院指导。这种形式的护理方式是（\qquad）\\
		      A.个案护理 \quad B.功能制护理 \quad C.责任制护理 \quad D.小组护理 \quad E.临床路径
	\end{enumerate}
\end{examplebox}
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 责任制护理的特点不包括（\qquad）\\
		      A.连续性 \quad B.整体性 \quad C.独立性 \quad D.协调性 \quad E.个体化
		\item 以下对临床护理工作模式描述正确的是（\qquad）\\
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 刚毕业的某护士接到明天到市人民医院面试的通知，她准备在着装方面体现护士的职业特点，以便给各位专家留下良好的印象，这体现了认知效应中的（\qquad）\\
		      A.近因效应 \quad B.社会固定印象 \quad C.首因效应 \quad D.晕轮效应 \quad E.先礼效应
		\item 新护士小李，今天第一天来上班。她微笑地面对每个人，耐心地解答患者的问题，为人处事都非常有礼貌，她想给大家留下一个好印象。小李护士运用的人际认知效应是（\qquad）\\
		      A.近因效应 \quad B.首因效应 \quad C.晕轮效应 \quad D.免疫效应 \quad E.先礼效应
		\item 在探视期间，来了5名家属探望一患儿，护士看到后，主动走出去与家属打招呼，并耐心解答他们的疑惑，然后恳请他们尽快离开病房让患儿休息。几位家属接受劝告，此护士较好作用了认知效应中的（\qquad）\\
		      A.首因效应 \quad B.先礼效应 \quad C.免疫效应 \quad D.晕轮效应 \quad E.近因效应
		\item 患者女，22岁。某大学三年级学生，护士在与患者沟通过程中，根据自己与大学生交往经验，以坦率、热情又亲切的态度与患者进行沟通，此护士的行为属于认知效应中的（\qquad）\\
		      A.晕轮效应 \quad B.免疫效应 \quad C.近因效应 \quad D.刻板印象 \quad E.首因效应
		\item 护士A是科里相貌气质最佳的护士，而且能歌善舞，护士长B非常欣赏。某次医院组织品管圈大赛，护士长B派出护士A参加，结果其成绩却是全组最低。护士长B认为护士A气质最佳，学习工作能力也应当最佳，这属于（\qquad）\\
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 患者男，30岁，半小时前因汽车撞伤头部入院，入院时已昏迷，对于此患者应采取的护患关系模式是（\qquad）\\
		      A.主动—主动型 \quad B.被动—被动型 \quad C.主动—被动型 \quad D.指导—合作型 \quad E.共同参与型
		\item 患者男性，38岁，二尖瓣置换术后第四天，各项生命体征正常，神智清醒，语词清晰，情绪平稳，应采用的护患关系基本模式是（\qquad）\\
		      A.主动-被动型 \quad B.指导-合作型 \quad C.指导-被动型 \quad D.被动-主动型 \quad E.共同参与型
		\item 病人，男，67岁，患高血压15年，本次因血压控制不好入院。护士应采取的护患关系模式是（\qquad）\\
		      A.主动-被动型 \quad B.指导-合作型 \quad C.指导-被动型 \quad D.被动-主动型 \quad E.共同参与型
	\end{enumerate}
\end{examplebox}
...
\begin{examplebox}{考题举例}
	\begin{enumerate}
		\item 患者，男，52岁，因肥厚型心肌病住院治疗出院后，患者仍十分紧张，整日卧床，不敢随意活动。该患者出现了（\qquad）\\
		      A.角色行为冲突 \quad B.角色行为减退 \quad C.角色行为强化 \quad D.角色行为缺如 \quad E.角色行为恐惧
		\item 张先生，诊断肺炎，住院后经治疗稍有好转，但这时他的妻子意外骨折，他立即出院去照顾妻子和女儿，他的这种行为是（\qquad）\\
		      A.角色行为冲突 \quad B.角色行为减退 \quad C.角色行为强化 \quad D.角色行为缺如 \quad E.角色行为恐惧
		\item 病人，女性，40岁。因“近日肝区疼痛，尤以进食油腻食物后疼痛加剧，大便呈陶土色”入院。病人自觉病情轻，要求白天请假回家治疗，对医生护士的嘱咐依从性较差。这种病人属于（\qquad）\\
